// Set chico de íconos SVG de línea (estilo Feather/Heroicons), usados en vez
// de emojis en toda la app — más prolijo y consistente con el resto del
// diseño (mismo criterio que ya habíamos aplicado en el toggle de modo oscuro).
// Todos aceptan className para que el color/tamaño se controlen desde afuera
// (currentColor + text-* / w-*/h-* de Tailwind).
...
export function PlaneIcon({ className = 'w-5 h-5' }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M21.5 3.5c.3.3.4.7.3 1.1l-4.2 15.6a1 1 0 0 1-1.7.4l-4-4.9-3 2.3a.75.75 0 0 1-1.2-.6v-3.6L2.9 10.4a1 1 0 0 1 .3-1.8l17.2-5.4c.4-.1.8 0 1.1.3Z" />
    </svg>
  )
}
